...
def generate_fish_list(data_dict, binary_cols, verbose=True):
    """
    Identify binary features requiring Fisher's exact test due to low expected frequencies (<5).

    Returns dict mapping data types to lists of feature names.
    """
    fish_dict = {}
